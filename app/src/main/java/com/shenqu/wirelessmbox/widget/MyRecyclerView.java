...
/**
 * Created by JongLim on 2017/1/19.
 * <p>
 * 支持上拉加载更多的
 *
 * @author 紫韶
    ...
    public class AutoLoadAdapter extends Adapter<ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            if (viewType == TYPE_FOOTER) {
                return new FooterViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.my_recyclerview_foot, parent, false));
            } else { // type normal
